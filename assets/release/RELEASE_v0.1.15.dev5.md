...
- **Terminus2 is now a bundled v1 CLI harness.** `Terminus2` runs Harbor's Terminus 2 agent behind the v1 harness boundary, lives under `verifiers.v1.packages.harnesses`, uses OpenAI-compatible proxy defaults, and captures optional Terminus2 logs as artifacts.
